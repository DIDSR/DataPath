...
Required Packages
--------------------------------------------------------
In order to use DataPath, you need to install some python packages. It is recommended to install the same version specified in this section (and in the requirement.txt). 

DataPath was tested on the following environments : 
...
For example, in DataPath we are using lxml which is one of the fastest and feature-rich libraries for processing XML and HTML in Python. 
...
Installing DataPath using Anaconda
--------------------------------------------------------
...
.. code-block:: console
    ...
    $ cd DataPath ROOT DIRECTORY
	
Download a complete copy of the ** DataPath **.

.. code-block:: console

    $ git clone https://github.com/mousavikahaki/DataPath
...
Create virtual environment for ** DataPath** using
...
.. code-block:: console
	...
	$ conda activate DataPath-dev
	
or

.. code-block:: console

    $ conda create -n DataPath python=3.8 

.. code-block:: console

    $ conda activate DataPath
...
Direct Installation of DataPath
--------------------------------------------------------

You can install required packages and then use pip to install the DataPath.
...
.. code-block:: console
    ...
    $ git clone https://github.com/mousavikahaki/DataPath.git
...
.. _Github repo: https://github.com/mousavikahaki/DataPath.git
# generate_dataset.py
DATAFILE_patient_list = '../../DATA/Master patient list for FDA 9-20-21_Seyed_v2.csv'
DATAFILE_dataset_features = '../../DATA/Aperio_datasetInfo_v2.csv'
OUTPUTDIR_WIN = '../../DATA/'
OUTPUTDIR_UBUNTU = '/home/seyedm.mousavikahaki/Documents/'
DATASETNAME = 'Aperio'
# TissueSegmentation2.py
SegmentationINPUTDIR = '/SubData/'
SegmentationOUTPUTDIR = '../../extracted_segmented/'
SegmentationTEMPDIR = "../../DATA/tmp/"
...
AnnotationExtractionSave_WSIs_win = '../../DATA/Washu-Aperio/*.svs'
# Patch Generator
...
PatchGenerator_OUTPUTDIR = '../../DATA/extracted_cutted/'
